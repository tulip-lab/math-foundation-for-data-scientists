...
There will be no examination for this unit, and the final assessment will be mainly based on your presentations. We provide a set of options for the presentations, and you are free to choose any option.
...
- If you find that you are having trouble meeting your deadlines, talk to the [Unit Chair](S00B-Team.md). 
...
- T03: **Chinese Restaurant Problem and Indian Buffet Problem** 
...
- T04: **Random Matrix Theory** 
  - `Random Matrix Theory` provides powerful tools and insights for understanding the behavior of complex systems with a large number of interacting components, as represented by matrices. Originally developed to understand the spectra of complex atomic nuclei in nuclear physics, RMT has grown to encompass a wide range of applications in various scientific fields, including statistical physics, number theory, and data science.
...
- The suggested email subject should be something like: `[M4DS] Presentation TXX (Group XXX)`. 
...
![GitHub watchers](https://img.shields.io/badge/Math-Learning--Activity-yellow)
...
![GitHub watchers](https://img.shields.io/badge/Math-Learning--Activity-yellow)
> :a: This is an optional activity scheduled in the middle of the delivery period. Students can either give some short presentation on their planned [Task :one:](#task-one---advanced-topic-presentation-25).
